      ...
      <div class="peak_content_top">
        <div class="peak_content_top_side">
          ...
          <div class="peak_content_top_side_search">
            ...
            <img class="peak_content_top_side_search_btn" src="../assets/images/home_search_icon.png" alt="" />
          </div>
        </div>
      </div>
      <div v-if="fromPage == 'home' && size !== Screen.Small" class="peak_content_section">
        ...
        <div class="open_more" @click="goToMore(true)" v-if="!showMore">{{ $t('home.see_more') }}</div>
        <div class="open_more" @click="goToMore(false)" v-if="showMore">{{ $t('home.close') }}</div>
      </div>
      <div v-if="fromPage == 'home' && size == Screen.Small" class="peak_content_section">
        <div class="peak_content_section_above">
    ...
    .middle_content {
      ...
      .peak_content_section {
        ...
        .peak_content_section_item {
          ...
          &:hover {
            background: radial-gradient(47.32% 47.32% at 50% 50%,
                #c5fcff 0%,
