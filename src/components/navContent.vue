  ...
  <div class="nav_content">
    <div class="nav_select">
      <div class="nav_select_left">
        <img src="../assets/images/logo.png" alt="" srcset="" @click="changeSelectIndex" />
        <div class="nav_select_left_title" @click="changeSelectIndex">UNCSCAN</div>
        <div v-if="size === Screen.Large" class="select_list">
          <div class="select_list_item" :class="selectIndex == -1 ? 'active' : ''" @click="changeSelectIndex">{{
            $t('nav.home') }}</div>
          <div v-for="(navItem, navIndex) in navSelectList" :key="navIndex">
            <el-dropdown popper-class="drop-menu" trigger="click" placement="bottom-start">
              <div class="select_list_item" :class="selectIndex == navIndex ? 'active' : ''">
                {{ $t(navItem.title) }}
              </div>
      ...
      <div class="nav_select_right">
        ...
        <div v-if="size === Screen.Large" class="language-container">
          ...
          <!--            />-->
          <!--          </el-select>-->
          <el-dropdown popper-class="drop-menu" trigger="click" placement="bottom-start" @command="handleLang">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item command="en">{{ $t('lang.en') }}
                </el-dropdown-item>
                <el-dropdown-item command="zh">{{ $t('lang.zh') }}
                </el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
