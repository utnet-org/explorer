...
export default {
  ...
  contract: {
    ...
    contract_pass: 'Pass',
    common: 'Common',
    piece_of_chip_information: 'Piece of Chip Information',
    messages: 'messages',
    ...
    two: 'second. ',
    three: 'third. ',
    Utility_project_introduction: 'Utility project introduction',
    How_to_mine_using_utility: 'How to mine using utility',
    Introduction_to_utility_development: 'Introduction to utility development',
  },
  static: {
    ...
    ReturnReceiptDetails: 'Return Receipt Details',
    Receipt_ID: 'Receipt ID',
    Block_Hash: 'Block Hash',
    Gas_and_tokens_consumed: 'Gas and tokens consumed',
    action: 'Action',
    result: 'Result',
    logs: 'Logs',
