  ...
  <div class="content">
    ...
    <div class="block_list">
      <div class="content_header">
        <div class="main_title">{{ $t('home.Verify_and_publish_contract_source_code') }}
        </div>
        <div class="sub_title">
      ...
      <div class="setion_input">
        ...
        <el-input class="input_element" v-model="address" :placeholder="$t('home.Please_enter_address')" clearable />
      </div>
      <div class="setion_input">
        <div class="setion_input_title">{{
          $t('home.Please_select_a_compiler')
        }}</div>
        <el-select-v2 v-model="compilerVersion" :options="CompilerVersionOptions"
          :placeholder="$t('home.Please_select_from')" :style="size === Screen.Large ? 'width: 50%;' : 'width: 90%;'"
      ...
      <div class="setion_input">
        ...
        <el-select-v2 v-model="openSourceLicenseTypes" :options="openSourceLicenseTypesOptions"
          :placeholder="$t('home.Please_select_from')" :style="size === Screen.Large ? 'width: 50%;' : 'width: 90%;'"
          filterable clearable />
      </div>
